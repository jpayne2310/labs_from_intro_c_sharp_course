...
namespace FormLayout
{
    public partial class FormLayout : Form
    {
        ...
        public void FillMyForm(int index)
        {
            ...
            cmbRelationship.Text = relate[index];
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            sal[Index] = salutation;
            fname[Index] = txtFName.Text;
            lname[Index] = txtLName.Text;
            str1[Index] = txtStreet1.Text;
            str2[Index] = txtStreet2.Text;
            city[Index] = txtCity.Text;
            state[Index] = cmbState.Text;
            zip[Index] = txtZip.Text;
            email[Index] = txtEmail.Text;
            hphone[Index] = txtHomePhone.Text;
            wphone[Index] = txtWorkPhone.Text;
            cphone[Index] = txtCellPhone.Text;
            bday[Index] = dtpBirthday.Text;
            annday[Index] = dtbAnniversary.Text;
            relate[Index] = cmbRelationship.Text;

            //call function to overwrite varibles
            lblFeedback.Text = fileIO.UpdateFile(saveLocate, sal, fname, lname,
                str1, str2, city, state, zip, email, hphone, wphone, cphone,
                bday, annday, relate);
        }
